...
/**
 * Enumerates the supported MIME types for input files.
 */
...
/**
 * Defines the structure for an input file associated with an event.
 * These are files provided by users or external systems.
 */
export interface BottInputFile {
  ...
  path: string;
  /** Optional reference to the entity this file is attached to. */
  parent?: BottEvent<AnyShape>;
}

/**
 * Enumerates the supported MIME types for output files.
 */
...
/**
 * Defines the structure for an output file associated with an event.
 * These are files generated by Bott.
 */
export interface BottOutputFile {
  ...
  /** The local path where the file is stored. */
  path: string;
  /** Optional reference to the entity that generated this file. */
  parent?: BottEvent<AnyShape>;
}
 ...
 * @template F - The type of files attached, defaults to `BottInputFile[] | BottOutputFile[]`.
 */
