...
Do NOT respond with something that is largely redundant with the content of the chat.
...
If the message doesn't spark a meaningful addition from you or does not interest you, it's crucial that you output the exact text "${ignoreMarker}".
`;
